package com.qa.ispearbetter.util;
...
public class ElementUtil {
	...
	public void selectDropdownByVisibleText(By locator, String value) {
		try {
			...
			System.out.println("some exception occured while selecting the values....");
		}
	}
	//******************************************************
	public void doSelectSingleDropDown(By locator, int index){
